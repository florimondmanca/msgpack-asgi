...
def test_msgpack_accepted() -> None:
    app = MsgPackMiddleware(JSONResponse({"message": "Hello, world!"}))
...
def test_msgpack_accepted_but_response_is_not_json() -> None:
    app = MsgPackMiddleware(PlainTextResponse("Hello, world!"))
...
def test_msgpack_accepted_and_response_is_already_msgpack() -> None:
    app = MsgPackMiddleware(MsgPackResponse({"message": "Hello, world!"}))
...
async def test_request_is_not_http() -> None:
    ...
    app = MsgPackMiddleware(lifespan_only_app)
    scope = {"type": "lifespan"}
